        ...
        FormLoadGate(
            ...
            OptionForm(
                ...
                labels = OptionFormLabels(
                    ...
                    colour = stringResource(R.string.projects_option_color),
                    icon = stringResource(R.string.projects_option_icon),
                    iconPlaceholder = stringResource(R.string.projects_option_icon_placeholder)
                ),
